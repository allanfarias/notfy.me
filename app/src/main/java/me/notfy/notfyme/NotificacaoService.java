...
public class NotificacaoService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageTitle, String messageBody, String link)
    {
        ...
        KeyguardManager km = (KeyguardManager) getApplicationContext().getSystemService(KEYGUARD_SERVICE);
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        ...
                        .setContentTitle("Titu "+messageTitle)
                        .setContentText("porra " + messageBody)
